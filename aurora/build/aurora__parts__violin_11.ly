...
\paper {
	...
	evenFooterMarkup = \markup { \fill-line { "violin 11 - mbrsi/aurora - josiah wolf oberholtzer" } }
	left-margin = 0.75\in
	max-systems-per-page = #8
	oddFooterMarkup = \markup { \fill-line { "josiah wolf oberholtzer - mbrsi/aurora - violin 11" } }
	print-page-number = ##t
	ragged-bottom = ##f
