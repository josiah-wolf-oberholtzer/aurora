...
\paper {
	...
	evenFooterMarkup = \markup { \fill-line { "cello 04 - mbrsi/aurora - josiah wolf oberholtzer" } }
	left-margin = 0.75\in
	max-systems-per-page = #8
	oddFooterMarkup = \markup { \fill-line { "josiah wolf oberholtzer - mbrsi/aurora - cello 04" } }
	print-page-number = ##t
	ragged-bottom = ##f
