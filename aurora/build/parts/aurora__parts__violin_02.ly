...
\paper {
	...
	evenFooterMarkup = \markup { \fill-line { "violin 02 - mbrsi/aurora - joséphine wolf oberholtzer" } }
	left-margin = 0.75\in
	max-systems-per-page = #7
	oddFooterMarkup = \markup { \fill-line { "joséphine wolf oberholtzer - mbrsi/aurora - violin 02" } }
	print-page-number = ##t
	ragged-bottom = ##f
