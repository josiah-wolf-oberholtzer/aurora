...
\paper {
	...
	evenFooterMarkup = \markup { \fill-line { "violin 05 - mbrsi/aurora - josiah wolf oberholtzer" } }
	left-margin = 0.75\in
	max-systems-per-page = #7
	oddFooterMarkup = \markup { \fill-line { "josiah wolf oberholtzer - mbrsi/aurora - violin 05" } }
	print-page-number = ##t
	ragged-bottom = ##f
