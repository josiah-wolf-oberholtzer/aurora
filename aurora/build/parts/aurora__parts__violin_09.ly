...
\paper {
	...
	evenFooterMarkup = \markup { \fill-line { "violin 09 - mbrsi/aurora - joséphine wolf oberholtzer" } }
	left-margin = 0.75\in
	max-systems-per-page = #8
	oddFooterMarkup = \markup { \fill-line { "joséphine wolf oberholtzer - mbrsi/aurora - violin 09" } }
	print-page-number = ##t
	ragged-bottom = ##f
