...
#        depth_density_goal = DepthDensityGoal(Duration(len(ensemble), 2))
        ...
        ### FILTERS ###
        random.seed(seed)
        gravity_filter = GravityFilter([[random.random(), random.random(), random.random()] \
        ...
        smcf = StaticMagnitudeClippingFilter(None, Duration(2))
